...
| Dune RP Web Routes
|--------------------------------------------------------------------------
| Ces routes sont automatiquement préfixées par 'dune-rp'
| et nommées avec le préfixe 'dune-rp.'
|--------------------------------------------------------------------------
*/

// ===== ROUTES PRINCIPALES =====
Route::get('/', [DuneRpController::class, 'index'])->name('index');
Route::get('/statistics', [DuneRpController::class, 'statistics'])->name('statistics');
Route::get('/lore', [DuneRpController::class, 'lore'])->name('lore');
